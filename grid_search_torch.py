...
for index, (batch_size, optimizer, learning_rate, model_name) in remaining_combinations:
    ...
    # Defining callbacks to be used in the model
    ...
    # This dictionary will be transformed into the .csv file with some results
    # Variables with 'None' value adressed would be correctly assingned
    # in the future.
    current_result = {
